...
b,e,c,h,d){a=d.length-1;switch(h){case 1:return d[a-1];case 2:this.$=new c.ProgramNode(d[a-2],d[a]);break;case 3:this.$=new c.ProgramNode(d[a]);break;case 4:this.$=new c.ProgramNode([]);break;case 5:this.$=[d[a]];break;case 6:d[a-1].push(d[a]);this.$=d[a-1];break;case 7:this.$=new c.InverseNode(d[a-2],d[a-1],d[a]);break;case 8:this.$=new c.BlockNode(d[a-2],d[a-1],d[a]);break;case 9:this.$=d[a];break;case 10:this.$=d[a];break;case 11:this.$=new c.ContentNode(d[a]);break;case 12:this.$=new c.CommentNode(d[a]);
break;case 13:this.$=new c.MustacheNode(d[a-1][0],d[a-1][1]);break;case 14:this.$=new c.MustacheNode(d[a-1][0],d[a-1][1]);break;case 15:this.$=d[a-1];break;case 16:this.$=new c.MustacheNode(d[a-1][0],d[a-1][1]);break;case 17:this.$=new c.MustacheNode(d[a-1][0],d[a-1][1],!0);break;case 18:this.$=new c.PartialNode(d[a-1]);break;case 19:this.$=new c.PartialNode(d[a-2],d[a-1]);break;case 21:this.$=[[d[a-2]].concat(d[a-1]),d[a]];break;case 22:this.$=[[d[a-1]].concat(d[a]),null];break;case 23:this.$=[[d[a-
1]],d[a]];break;case 24:this.$=[[d[a]],null];break;case 25:d[a-1].push(d[a]);this.$=d[a-1];break;case 26:this.$=[d[a]];break;case 27:this.$=d[a];break;case 28:this.$=new c.StringNode(d[a]);break;case 29:this.$=new c.IntegerNode(d[a]);break;case 30:this.$=new c.BooleanNode(d[a]);break;case 31:this.$=new c.HashNode(d[a]);break;case 32:d[a-1].push(d[a]);this.$=d[a-1];break;case 33:this.$=[d[a]];break;case 34:this.$=[d[a-2],d[a]];break;case 35:this.$=[d[a-2],new c.StringNode(d[a])];break;case 36:this.$=
[d[a-2],new c.IntegerNode(d[a])];break;case 37:this.$=[d[a-2],new c.BooleanNode(d[a])];break;case 38:this.$=new c.IdNode(d[a]);break;case 39:d[a-2].push(d[a]);this.$=d[a-2];break;case 40:this.$=[d[a]]}},table:[{3:1,4:2,5:[2,4],6:3,8:4,9:5,11:6,12:7,13:8,14:[1,9],15:[1,10],16:[1,12],19:[1,11],22:[1,13],23:[1,14],24:[1,15]},{1:[3]},{5:[1,16]},{5:[2,3],7:17,8:18,9:5,11:6,12:7,13:8,14:[1,9],15:[1,10],16:[1,12],19:[1,19],20:[2,3],22:[1,13],23:[1,14],24:[1,15]},{5:[2,5],14:[2,5],15:[2,5],16:[2,5],19:[2,
...
{};a=this.lexer.yylloc;d.push(a);if(typeof this.yy.parseError==="function")this.parseError=this.yy.parseError;for(var i,o,j,l,s={},t,p;;){j=c[c.length-1];this.defaultActions[j]?l=this.defaultActions[j]:(i==null&&(i=b()),l=q[j]&&q[j][i]);if(typeof l==="undefined"||!l.length||!l[0]){if(!k){o=[];for(t in q[j])this.terminals_[t]&&t>2&&o.push("'"+this.terminals_[t]+"'");var u="",u=this.lexer.showPosition?"Parse error on line "+(r+1)+":\n"+this.lexer.showPosition()+"\nExpecting "+o.join(", "):"Parse error on line "+
(r+1)+": Unexpected "+(i==1?"end of input":"'"+(this.terminals_[i]||i)+"'");this.parseError(u,{text:this.lexer.match,token:this.terminals_[i]||i,line:this.lexer.yylineno,loc:a,expected:o})}if(k==3){if(i==1)throw Error(u||"Parsing halted.");n=this.lexer.yyleng;m=this.lexer.yytext;r=this.lexer.yylineno;a=this.lexer.yylloc;i=b()}for(;;){if((2).toString()in q[j])break;if(j==0)throw Error(u||"Parsing halted.");c.length-=2;h.length-=1;d.length-=1;j=c[c.length-1]}o=i;i=2;j=c[c.length-1];l=q[j]&&q[j][2];
k=3}if(l[0]instanceof Array&&l.length>1)throw Error("Parse Error: multiple actions possible at state: "+j+", token: "+i);switch(l[0]){case 1:c.push(i);h.push(this.lexer.yytext);d.push(this.lexer.yylloc);c.push(l[1]);i=null;o?(i=o,o=null):(n=this.lexer.yyleng,m=this.lexer.yytext,r=this.lexer.yylineno,a=this.lexer.yylloc,k>0&&k--);break;case 2:p=this.productions_[l[1]][1];s.$=h[h.length-p];s._$={first_line:d[d.length-(p||1)].first_line,last_line:d[d.length-1].last_line,first_column:d[d.length-(p||1)].first_column,
last_column:d[d.length-1].last_column};j=this.performAction.call(s,m,n,r,this.yy,l[1],h,d);if(typeof j!=="undefined")return j;p&&(c=c.slice(0,p*-2),h=h.slice(0,-1*p),d=d.slice(0,-1*p));c.push(this.productions_[l[1]][0]);h.push(s.$);d.push(s._$);l=q[c[c.length-2]][c[c.length-1]];c.push(l);break;case 3:return!0}}return!0}},e=function(){return{EOF:1,parseError:function(a,b){if(this.yy.parseError)this.yy.parseError(a,b);else throw Error(a);},setInput:function(a){this._input=a;this._more=this._less=this.done=
...
exports.main(typeof process!=="undefined"?process.argv.slice(1):require("system").args);var Handlebars={VERSION:"1.0.beta.2"};Handlebars.Parser=handlebars;Handlebars.parse=function(b){Handlebars.Parser.yy=Handlebars.AST;return Handlebars.Parser.parse(b)};Handlebars.print=function(b){return(new Handlebars.PrintVisitor).accept(b)};Handlebars.helpers={};Handlebars.partials={};Handlebars.registerHelper=function(b,e,a){if(a)e.not=a;this.helpers[b]=e};
...
a;this.string=a.join(".");this.depth=f;this.isSimple=a.length===1&&f===0};Handlebars.AST.StringNode=function(b){this.type="STRING";this.string=b};Handlebars.AST.IntegerNode=function(b){this.type="INTEGER";this.integer=b};Handlebars.AST.BooleanNode=function(b){this.type="BOOLEAN";this.bool=b};Handlebars.AST.CommentNode=function(b){this.type="comment";this.comment=b}})();Handlebars.Visitor=function(){};Handlebars.Visitor.prototype={accept:function(b){return this[b.type](b)}};
Handlebars.Exception=function(b){this.message=b};Handlebars.SafeString=function(b){this.string=b};Handlebars.SafeString.prototype.toString=function(){return this.string.toString()};
...
c.escaped?this.opcode("appendEscaped"):this.opcode("append")},ID:function(c){this.addDepth(c.depth);this.opcode("getContext",c.depth);this.opcode("lookupWithHelpers",c.parts[0]||null);for(var a=1,b=c.parts.length;a<b;a++)this.opcode("lookup",c.parts[a])},STRING:function(c){this.opcode("pushString",c.string)},INTEGER:function(c){this.opcode("push",c.integer)},BOOLEAN:function(c){this.opcode("push",c.bool)},comment:function(){},pushParams:function(c){for(var a=c.length,b;a--;)if(b=c[a],this.options.stringParams)b.depth&&
this.addDepth(b.depth),this.opcode("getContext",b.depth||0),this.opcode("pushStringParam",b.string);else this[b.type](b)},opcode:function(c,a,d){this.opcodes.push(b.OPCODE_MAP[c]);a!==void 0&&this.opcodes.push(a);d!==void 0&&this.opcodes.push(d)},declare:function(c,a){this.opcodes.push("DECLARE");this.opcodes.push(c);this.opcodes.push(a)},addDepth:function(c){c!==0&&!this.depths[c]&&(this.depths[c]=!0,this.depths.list.push(c))},setupStackForMustache:function(c){var a=c.params;this.pushParams(a);c.hash?
this.hash(c.hash):this.opcode("push","{}");this.ID(c.id);return a}};e.prototype={nameLookup:function(c,a){return e.RESERVED_WORDS[a]||a.indexOf("-")!==-1||!isNaN(a)?c+"['"+a+"']":/^[0-9]+$/.test(a)?c+"["+a+"]":c+"."+a},appendToBuffer:function(a){return"buffer = buffer + "+a+";"},initializeBuffer:function(){return this.quotedString("")},compile:function(a,b){this.environment=a;this.options=b||{};this.preamble();this.stackSlot=0;this.stackVars=[];this.registers={list:[]};this.compileChildren(a,b);Handlebars.log(Handlebars.logger.DEBUG,
a.disassemble()+"\n\n");var d=a.opcodes;this.i=0;for(g=d.length;this.i<g;this.i++)d=this.nextOpcode(0),d[0]==="DECLARE"?(this.i+=2,this[d[1]]=d[2]):(this.i+=d[1].length,this[d[0]].apply(this,d[1]));return this.createFunction()},nextOpcode:function(a){var h=this.environment.opcodes,d=h[this.i+a],e,m;if(d==="DECLARE")return e=h[this.i+1],a=h[this.i+2],["DECLARE",e,a];else{e=b.DISASSEMBLE_MAP[d];d=b.multiParamSize(d);m=[];for(var f=0;f<d;f++)m.push(h[this.i+f+1+a]);return[e,m]}},eat:function(a){this.i+=
a.length},preamble:function(){var a=[];a.push("var buffer = "+this.initializeBuffer()+", currentContext = context");var b="helpers = helpers || Handlebars.helpers;";this.environment.usePartial&&(b+=" partials = partials || Handlebars.partials;");a.push(b);this.lastContext=0;this.source=a},createFunction:function(){var a={escapeExpression:Handlebars.Utils.escapeExpression,invokePartial:Handlebars.VM.invokePartial,programs:[],program:function(a,c,b,d){var e=this.programs[a];return d?Handlebars.VM.program(this.children[a],
c,b,d):(e||(e=this.programs[a]=Handlebars.VM.program(this.children[a],c,b)),e)},programWithDepth:Handlebars.VM.programWithDepth,noop:Handlebars.VM.noop},b=this.stackVars.concat(this.registers.list);b.length>0&&(this.source[0]=this.source[0]+", "+b.join(", "));this.source[0]+=";";this.source.push("return buffer;");b=["Handlebars","context","helpers","partials"];this.options.data&&b.push("data");for(var d=0,e=this.environment.depths.list.length;d<e;d++)b.push("depth"+this.environment.depths.list[d]);
b.length===4&&!this.environment.usePartial&&b.pop();b.push(this.source.join("\n"));b=Function.apply(this,b);b.displayName="Handlebars.js";Handlebars.log(Handlebars.logger.DEBUG,b.toString()+"\n\n");a.render=b;a.children=this.environment.children;return function(b,d){try{var d=d||{},e=[Handlebars,b,d.helpers,d.partials,d.data],h=Array.prototype.slice.call(arguments,2),e=e.concat(h);return a.render.apply(a,e)}catch(f){throw f;}}},appendContent:function(a){this.source.push(this.appendToBuffer(this.quotedString(a)))},
append:function(){var a=this.popStack();this.source.push("if("+a+" || "+a+" === 0) { "+this.appendToBuffer(a)+" }")},appendEscaped:function(){var a=this.nextOpcode(1),b="";a[0]==="appendContent"&&(b=" + "+this.quotedString(a[1][0]),this.eat(a));this.source.push(this.appendToBuffer("this.escapeExpression("+this.popStack()+")"+b))},getContext:function(a){if(this.lastContext!==a)this.lastContext=a,a===0?this.source.push("currentContext = context;"):this.source.push("currentContext = depth"+a+";")},lookupWithHelpers:function(a){if(a){var b=
this.nextStack();this.source.push("if('"+a+"' in helpers) { "+b+" = "+this.nameLookup("helpers",a,"helper")+"; } else { "+b+" = "+this.nameLookup("currentContext",a,"context")+"; }")}else this.pushStack("currentContext")},lookup:function(a){var b=this.topStack();this.source.push(b+" = "+this.nameLookup(b,a,"context")+";")},pushStringParam:function(a){this.pushStack("currentContext");this.pushString(a)},pushString:function(a){this.pushStack(this.quotedString(a))},push:function(a){this.pushStack(a)},
invokeMustache:function(a,b){this.populateParams(a,this.quotedString(b),"{}",null,function(a,b,c){this.source.push("else if("+c+"=== undefined) { "+a+" = helpers.helperMissing.call("+b+"); }");this.source.push("else { "+a+" = "+c+"; }")})},invokeProgram:function(a,b){var d=this.programExpression(this.inverse),e=this.programExpression(a);this.populateParams(b,null,e,d,function(a,b){this.source.push("else { "+a+" = helpers.blockHelperMissing.call("+b+"); }")})},populateParams:function(a,b,d,e,f){var g=
this.popStack(),n=[],k=this.popStack();this.register("tmp1",d);this.source.push("tmp1.hash = "+k+";");this.options.stringParams&&this.source.push("tmp1.contexts = [];");for(k=0;k<a;k++)d=this.popStack(),n.push(d),this.options.stringParams&&this.source.push("tmp1.contexts.push("+this.popStack()+");");e&&(this.source.push("tmp1.fn = tmp1;"),this.source.push("tmp1.inverse = "+e+";"));this.options.data&&this.source.push("tmp1.data = data;");n.push("tmp1");e&&n.push(e);this.populateCall(n,g,b||g,f)},populateCall:function(a,
b,d,e){var f=["context"].concat(a).join(", "),a=["context"].concat(d).concat(a).join(", ");nextStack=this.nextStack();this.source.push("if(typeof "+b+" === 'function') { "+nextStack+" = "+b+".call("+f+"); }");e.call(this,nextStack,a,b)},invokeInverse:function(a){a=this.programExpression(a);this.pushStack("helpers.blockHelperMissing.call("+["context",this.topStack(),"this.noop",a].join(", ")+")")},invokePartial:function(a){this.pushStack("this.invokePartial("+this.nameLookup("partials",a,"partial")+
", '"+a+"', "+this.popStack()+", helpers, partials);")},assignToHash:function(a){var b=this.popStack();this.source.push(this.topStack()+"['"+a+"'] = "+b+";")},compiler:e,compileChildren:function(a,b){for(var d=a.children,e,f,g=[],n=0,k=d.length;n<k;n++)e=d[n],f=new this.compiler,g[n]=f.compile(e,b);a.rawChildren=d;a.children=g},programExpression:function(a){if(a==null)return"this.noop";var b=[a,"helpers","partials"],d=this.environment.rawChildren[a].depths.list;this.options.data&&b.push("data");for(var e=
0,f=d.length;e<f;e++)depth=d[e],depth===1?b.push("context"):b.push("depth"+(depth-1));this.environment.usePartial||(b[3]?b[2]="null":b.pop());return d.length===0?"this.program("+b.join(", ")+")":(b[0]="this.children["+a+"]","this.programWithDepth("+b.join(", ")+")")},register:function(a,b){this.useRegister(a);this.source.push(a+" = "+b+";")},useRegister:function(a){this.registers[a]||(this.registers[a]=!0,this.registers.list.push(a))},pushStack:function(a){this.source.push(this.nextStack()+" = "+
a+";");return"stack"+this.stackSlot},nextStack:function(){this.stackSlot++;this.stackSlot>this.stackVars.length&&this.stackVars.push("stack"+this.stackSlot);return"stack"+this.stackSlot},popStack:function(){return"stack"+this.stackSlot--},topStack:function(){return"stack"+this.stackSlot},quotedString:function(a){return'"'+a.replace(/\\/g,"\\\\").replace(/"/g,'\\"').replace(/\n/g,"\\n").replace(/\r/g,"\\r")+'"'}};a="break case catch continue default delete do else finally for function if in instanceof new return switch this throw try typeof var void while with null true false".split(" ");
compilerWords=e.RESERVED_WORDS={};for(var f=0,g=a.length;f<g;f++)compilerWords[a[f]]=!0})(Handlebars.Compiler,Handlebars.JavaScriptCompiler);
